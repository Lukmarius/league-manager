...
import pl.mjaskola.app.repository.CustomTeamRepository;
...
@Service
@Transactional
public class CustomTeamServiceImpl implements TeamService {

    private final Logger log = LoggerFactory.getLogger(CustomTeamServiceImpl.class);

    private final CustomTeamRepository teamRepository;
    private final UserService userService;
    private final TeamMapper teamMapper;

    public CustomTeamServiceImpl(CustomTeamRepository teamRepository, UserService userService, TeamMapper teamMapper) {
    ...
    public List<TeamDTO> findAll() {
        log.debug("Request to get all Teams by User");
