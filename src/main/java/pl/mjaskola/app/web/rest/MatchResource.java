...
import pl.mjaskola.app.service.MatchQueryService;
...
/**
 * REST controller for managing {@link pl.mjaskola.app.domain.Match}.
 */
@RestController
@RequestMapping("/api")
public class MatchResource {
    ...
    public MatchResource(MatchService matchService, MatchRepository matchRepository, MatchQueryService matchQueryService) {
    ...
    public ResponseEntity<MatchDTO> createMatch(@RequestBody MatchDTO matchDTO) throws URISyntaxException {
        ...
        if (Objects.isNull(matchDTO.getMatchResult())) {
